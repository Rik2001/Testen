...
<script>
  ...
  function AddPizza(){
    ...
    block_to_insert.innerHTML = ' <form id="form1" action="Pizza.php"> <p>Type Pizza</p><select id="pizza'+pizzaCount+'" name="pizza1"><option value="Margharita">Margharita</option><option value="Hawaii">Hawaii</option><option value="Peperoni">Peperoni</option></select><br><p>Grootte Pizza</p><input type="radio" id="sizeGroot" name="size'+pizzaCount+'" value="Groot" checked> Groot<input type="radio" id="sizeKlein" name="size'+pizzaCount+'" value="Klein"> Klein<br><br></form>'
